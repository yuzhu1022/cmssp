...
public final class ID {
	...
	public static final String TAG = "IDEMPTY";
    ...
    private static int filterIdentifier(String name, String defType,
            int identifier) {
        if (identifier == 0) {
        	Log.w(TAG, "name:"+name+" defType:"+defType+" identifier:"+identifier);
        }
        return identifier;
    }
