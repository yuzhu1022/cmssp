package com.ox.widgets.pullToRefreshView;
 ...
 * contentView.setAdapter(new RecyclerAdapter<Entity>(context , R.id.layout_entity) {
    @Override
    protected void convert(RecyclerAdapterHelper helper, Entity item) {

    }
    });
 */
public class OXRecyclerView extends RecyclerView {
    ...
    public OXRecyclerView(Context context) {
        this(context, null);
    }

    public OXRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OXRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        public void onChanged() {
            ...
            if (adapter != null && mEmptyView != null) {
                ...
                if (adapter.getItemCount() == emptyCount) {
                    ...
                    OXRecyclerView.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    OXRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
